...
public class IntegrationTests {
	...
	private void populateDatabaseForTests(Blackboard blackboard) {
		...
		Course course = blackboard.getByID(Course.class, 1);
		OptimizerCalculation optimizerCalculation = blackboard.getByID(OptimizerCalculation.class, 1); 
		OBoard.createOutputOfferedCourse(course, optimizerCalculation);
...
//		userBoard.addUserCourseAssignment(5, 1, 1);		
	...
	public void courseRecommendationsTest() {
		...
		id = semesterService.getOptimizerCalculationId(false, new GregorianCalendar(2015,9,10,10,10,11));
		assertEquals(2, id);
