...
public class NextSemesterCoursesController extends Controller {
	...
	private HashMap<String, Object> createModel(Request request) {
		...
		List<StudentCourseRecommendation> currentStudentSolutionRecommendations = userService.getStudentCourseRecommendations(currentUser.getId(), currentOptimizerId);
